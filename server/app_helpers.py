...
# # we have deprecated UnitTask.dependencies and replaced with UnitTask.parents
# # however, it appears to me that this function should be recursively updating children of tasks...    
# # @task_model: UnitTask 
...
def unit_task_recursively_update_children(task_model): 
    # @task_model: UnitTask 
    pass
    # recursively_update_dependencies(task_model)

def master_task_recursively_update_children(task_model):
    # @task_model: MasterTask 
