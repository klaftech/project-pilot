export function initTasks() {
    ...
    */
    ...
    const constructionTasks = [{"id": "206", "name": "Sign Contract", "start": "2025-01-28", "end": "2025-02-04", "days_length": 7, "progress": 0, "dependencies": []}, {"id": "617", "name": "Engineer Approval", "start": "2025-01-28", "end": "2025-02-04", "days_length": 7, "progress": 0, "dependencies": []}, {"id": "710", "name": "Sitework", "start": "2025-02-05", "end": "2025-03-07", "days_length": 30, "progress": 0, "dependencies": ["206"]}, {"id": "171", "name": "Arrange Payment", "start": "2025-02-05", "end": "2025-02-19", "days_length": 14, "progress": 0, "dependencies": ["206"]}, {"id": "417", "name": "Apply for Permits", "start": "2025-02-05", "end": "2025-02-12", "days_length": 7, "progress": 0, "dependencies": ["206", "617"]}, {"id": "591", "name": "Level Site", "start": "2025-03-08", "end": "2025-03-22", "days_length": 14, "progress": 0, "dependencies": ["710", "417"]}, {"id": "643", "name": "Foundation", "start": "2025-03-23", "end": "2025-04-06", "days_length": 14, "progress": 0, "dependencies": ["591"]}, {"id": "650", "name": "Survey Ground", "start": "2025-03-23", "end": "2025-03-26", "days_length": 3, "progress": 0, "dependencies": ["591", "417"]}]

    return constructionTasks.map((task) => ({
        id: task.id,
        name: task.name,
        type: task.id == "20" ? 'project' : 'task',
