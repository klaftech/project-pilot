...
import DetailsCardUpdates from './DetailsCardUpdates'
import LoadingWrapper from "@/components/LoadingWrapper"

function DetailsCardUpdatesWrapper({ taskId }) {    
    ...
    return (
        <>
            <Card>
                <DetailsCardUpdates updates={updates} />
...
export default DetailsCardUpdatesWrapper